...
//add start  button
this._startButton = new objects.Button("playButton",380,300, true);
this.addChild(this._startButton);
//startbutton event listener
this._startButton.on("click",this._startButtonClick,this);

//add tutorial button
this._tutorialButton = new objects.Button("tutButton", 380, 350, true);
this.addChild(this._tutorialButton);
//tutButton listener
this._tutorialButton.on("click", this._tutButtonClick, this);

//add development buttin
this._pathButton = new objects.Button("againButton",380, 400, true);
